...
public class DBConnection {
    private static final String SERVER_NAME = "ADMIN"; // Thay thế bằng tên server của bạn
    ...
    private static final String PASSWORD = "123456"; // Thay thế bằng password của bạn
